...
public class StreamFetcher {
     ...
     * 扩展名
     */
    private String extName = UNKNOWN_KEY;
     ...
     * @param unid         文档unid
     */
    public StreamFetcher(String fullFileName, String unid) {
    ...
    /**
     * 获取附件文件的ContentType类型
     *
     * @return image/gif...等 未知扩展名返回application/octet-stream
     */
    ...
    /**
     * 获取扩展名对应的文件的ContentType类型
     *
     * @param ext 扩展名
     * @return 如image/gif...等 未知扩展名返回application/octet-stream
     */
