            ...
            <nav class="main-nav">
                <div class="menu-top-menu-container">
                    <ul id="menu-top-menu" class="clearfix">
                        <li class="current-menu-item"><a href="../html/portal/index-2.html">主页</a></li>
                        <%--<li><a href="home-categories-description.html">Home 2</a></li>--%>
                        <%--<li><a href="home-categories-articles.html">Home 3</a></li>--%>
                        <li><a href="../html/portal/articles-list.html">文章列表</a></li>
                        <li><a href="../html/portal/faq.html">常见问题</a></li>
                        <li><a href="#">换肤</a>
                            <ul class="sub-menu">
                                <li><a href="../html/portal/blue-skin.html">蓝色皮肤</a></li>
                                <li><a href="../html/portal/green-skin.html">绿色皮肤</a></li>
                                <li><a href="../html/portal/red-skin.html">红色皮肤</a></li>
                                <li><a href="../html/portal/index-2.html">默认皮肤</a></li>
                            </ul>
                        </li>
                        <li><a href="#">更多</a>
                            <ul class="sub-menu">
                                <li><a href="../html/portal/full-width.html">Full Width</a></li>
                                <li><a href="../html/portal/elements.html">Elements</a></li>
                                <li><a href="../html/portal/page.html">Sample Page</a></li>
                            </ul>
                        </li>
                        <li><a href="../html/portal/contact.html">联系我</a></li>
                    </ul>
                </div>
            </nav>
                ...
                <div class="row separator">
                    <section class="span4 articles-list">
                        ...
                        <ul class="articles">
                            <li class="article-entry standard">
                                <h4><a href="../html/portal/single.html">Integrating WordPress with Your Website</a></h4>
                                <span class="article-meta">2013-02-25 发布于 <a href="#" title="View all posts in Server &amp; Database">服务器 &amp; 数据库</a></span>
                                <span class="like-count">66</span>
                            </li>
                            <li class="article-entry standard">
                                <h4><a href="../html/portal/single.html">WordPress Site Maintenance</a></h4>
                                <span class="article-meta">24 Feb, 2013 in <a href="#" title="View all posts in Website Dev">Website Dev</a></span>
                                <span class="like-count">15</span>
                            </li>
                            <li class="article-entry video">
                                <h4><a href="../html/portal/single.html">Meta Tags in WordPress</a></h4>
                                <span class="article-meta">23 Feb, 2013 in <a href="#" title="View all posts in Website Dev">Website Dev</a></span>
                                <span class="like-count">8</span>
                            </li>
                            <li class="article-entry image">
                                <h4><a href="../html/portal/single.html">WordPress in Your Language</a></h4>
                                <span class="article-meta">22 Feb, 2013 in <a href="#" title="View all posts in Advanced Techniques">Advanced Techniques</a></span>
                                <span class="like-count">6</span>
                            </li>
                            <li class="article-entry standard">
                                <h4><a href="../html/portal/single.html">Know Your Sources</a></h4>
                                <span class="article-meta">22 Feb, 2013 in <a href="#" title="View all posts in Website Dev">Website Dev</a></span>
                                <span class="like-count">2</span>
                            </li>
                            <li class="article-entry standard">
                                <h4><a href="../html/portal/single.html">Validating a Website</a></h4>
                    ...
                    <section class="span4 articles-list">
                        ...
                        <ul class="articles">
                            ...
                            <li class="article-entry standard">
                                <h4><a href="../html/portal/single.html">Using Javascript</a></h4>
                            ...
                            <li class="article-entry image">
                                <h4><a href="../html/portal/single.html">Using Images</a></h4>
                            ...
                            <li class="article-entry video">
                                <h4><a href="../html/portal/single.html">Using Video</a></h4>
                            ...
                            <li class="article-entry standard">
                                <h4><a href="../html/portal/single.html">WordPress CSS Information and Techniques</a></h4>
                ...
                <section class="widget">
                    <div class="quick-links-widget">
                        ...
                        <ul id="menu-quick-links" class="menu clearfix">
                            <li><a href="../html/portal/index-2.html">主页</a></li>
                            <li><a href="../html/portal/articles-list.html">文章列表</a></li>
                            <li><a href="../html/portal/faq.html">常见问题解答</a></li>
                            <li><a href="../html/portal/contact.html">联系我</a></li>
                        </ul>
                    </div>
                </section>
